	...
	generate: {
		value: function() {
			...
			process.nextTick(function() {
				textGridCommand = node_config.praatCommand + __dirname.replace(/lib$/g, "") + "node_modules/praat-scripts/praat-script-syllable-nuclei-v2file.praat -20 4 0.4 0.1 no \"" + self.workingDir + "\"   \"" + self.wavFile + "\""; //+ " 2>&1 ";
